	...
	return (
		<section id="contact" className="py-12 sm:py-20 px-4 bg-[#161B22] scroll-mt-20">
			<div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
				<h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">Construisons ensemble votre prochain projet</h2>
				<p className="text-sm sm:text-base text-gray-400 mb-6">Si vous recherchez un developpeur Python Passionné et Autonome</p>
				...
				<div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
					<a
						href="mailto:jmillot41@gmail.com"
				...
				<div className="flex justify-center gap-6">
					...
					<a
						href="https://www.linkedin.com/in/julien-millot/"
						target="_blank"
						rel="noopener noreferrer"
						className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
					>
